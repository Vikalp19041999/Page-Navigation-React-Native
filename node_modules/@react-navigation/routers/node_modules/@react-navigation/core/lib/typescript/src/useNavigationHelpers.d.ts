...
import { NavigationProp, NavigationAction, NavigationState, Router, PrivateValueStore } from './types';
...
export default function useNavigationHelpers<State extends NavigationState, Action extends NavigationAction, EventMap extends Record<string, any>>({ onAction, getState, emitter, router }: Options<State, Action>): {
    ...
    reset(state: NavigationState | import("./types").PartialState<NavigationState>): void;
    goBack(): void;
    isFocused(): boolean;
    canGoBack(): boolean;
